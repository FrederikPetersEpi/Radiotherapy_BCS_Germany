# Fehlerdoku
# tumor: inzidenzort sollte ortsteilnummer sein!
# op_typid und opsid vielleicht vertauscht
# Arbeitsspeicher leeren

# To do: 
# vorzeitige Sterblichkeit als Proxy für schlechtes Gesundheitsverhalten
# Mastektomierate als Proxy für Wunsch nach intensiver Behandlung
# Variable Ost/West mit ins Modell
# neoadjuvante Therapie mit ins Modell
rm(list=ls())
